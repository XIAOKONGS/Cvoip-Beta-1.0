...
Private Sub UserControl_Paint()
    ...
    With UserControl
        ...
        '............................................................
        If LenB(StrConv(mCaption, vbFromUnicode)) < 0 Then Exit Sub
        Select Case mCaptionAlignment
            Case Is = TopCaption
                GetTextExtentPoint32 .hdc, mCaption, LenB(StrConv(mCaption, vbFromUnicode)), CaptionPos(1)
            ...
            Select Case mCaptionEffect
                Case Is = Default
                    If MouseDown Then
                        ...
                        TextOutA .hdc, CaptionPos(0).x + 1, CaptionPos(0).y + 1, mCaption, LenB(StrConv(mCaption, vbFromUnicode))
                    ElseIf MouseMove Then
                        .ForeColor = mForeColorHover
                        TextOutA .hdc, CaptionPos(0).x, CaptionPos(0).y, mCaption, LenB(StrConv(mCaption, vbFromUnicode))
                    Else
                        .ForeColor = mForeColor
                        TextOutA .hdc, CaptionPos(0).x, CaptionPos(0).y, mCaption, LenB(StrConv(mCaption, vbFromUnicode))
                    End If
                Case Is = Raised
                    ...
                    If MouseDown Then
                        ...
                        TextOutW .hdc, CaptionPos(0).x + EFF.x + 1, CaptionPos(0).y + EFF.y + 1, mCaption, LenB(StrConv(mCaption, vbFromUnicode))
                        .ForeColor = mForeColorPressed       '>> mForeColorPressed If You Like.
                        TextOutA .hdc, CaptionPos(0).x + 1, CaptionPos(0).y + 1, mCaption, LenB(StrConv(mCaption, vbFromUnicode))
                    ElseIf MouseMove Then
                        .ForeColor = mEffectColor          '>> Vbwhite
                        TextOutW .hdc, CaptionPos(0).x + EFF.x, CaptionPos(0).y + EFF.y, mCaption, LenB(StrConv(mCaption, vbFromUnicode))
                        .ForeColor = mForeColorHover
                        TextOutA .hdc, CaptionPos(0).x, CaptionPos(0).y, mCaption, LenB(StrConv(mCaption, vbFromUnicode))
                    Else
                ...
                Case Is = Outline
                    ...
                    For Out.x = -1 To 1                    '>> -1 Pixel And +1 Pixel From Top To Down
                        For Out.y = -1 To 1                '>> -1 Pixel And +1 Pixel From Left To Right
                            If MouseDown Then
                                .ForeColor = mEffectColor
                                TextOutW .hdc, CaptionPos(0).x + Out.x + 1, CaptionPos(0).y + Out.y + 1, mCaption, LenB(StrConv(mCaption, vbFromUnicode))
                                .ForeColor = mForeColorPressed
                                TextOutA .hdc, CaptionPos(0).x + 1, CaptionPos(0).y + 1, mCaption, LenB(StrConv(mCaption, vbFromUnicode))
                            ElseIf MouseMove Then
                                .ForeColor = mEffectColor
                                TextOutW .hdc, CaptionPos(0).x + Out.x, CaptionPos(0).y + Out.y, mCaption, LenB(StrConv(mCaption, vbFromUnicode))
                                .ForeColor = mForeColorHover
                                TextOutA .hdc, CaptionPos(0).x, CaptionPos(0).y, mCaption, LenB(StrConv(mCaption, vbFromUnicode))
                            Else
                                .ForeColor = mEffectColor
        ...
        Else    '>> If Enabled = False Then >> Draw Disabled Text Sunken Look
            ...
            Else    '>> If Enabled = False Then >> Draw Disabled Text Sunken Look
                ...
                TextOutW .hdc, CaptionPos(0).x + 1, CaptionPos(0).y + 1, mCaption, LenB(StrConv(mCaption, vbFromUnicode))
                .ForeColor = vb3DShadow
                TextOutA .hdc, CaptionPos(0).x, CaptionPos(0).y, mCaption, LenB(StrConv(mCaption, vbFromUnicode))
            End If
        End If
        ...
        '............................................................
        If LenB(StrConv(mCaption, vbFromUnicode)) > 0 Then
